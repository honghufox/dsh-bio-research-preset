...
(async () => {
  ...
  r = await fetch('http://127.0.0.1:8765/asr/peek');
  ...
  // stop
  r = await fetch('http://127.0.0.1:8765/asr/stop', { method: 'POST' });
  ...
  // CORS header present
  r = await fetch('http://127.0.0.1:8765/asr/health');
